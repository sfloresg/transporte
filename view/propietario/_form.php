...
<?php header_form('Mantenimiento de propietario'); ?>   
    ...
    <div class="contFrm" style="background: #fff;">
        <div style="margin:0 auto; ">                
                ...
                <input type="text" id="idempleado" maxlength="8" name="idempleado" class="text ui-widget-content ui-corner-all" style=" width: 100px; text-align: left;" value="<?php echo $obj->idempleado; ?>" <?php echo $readonly; ?> title="Ingrese su DNI o su codigo de propietario" />
                <br/>
