...
<?php header_form('Mantenimiento de Empleados'); ?>   
    ...
    <div class="contFrm" style="background: #fff;">
        <div style="margin:0 auto; ">                
                ...
                <input type="text" id="idempleado" name="idempleado" class="text ui-widget-content ui-corner-all" style=" width: 100px; text-align: left;" value="<?php echo $obj->idempleado; ?>" <?php echo $readonly; ?> title="Ingrese su DNI o su codigo de Cuadrilla" />
                <br/>
                ...
                <?php echo $oficina; ?>
                <br/>
                <label for="idgrupo" class="labels">Grupo:</label>
                <?php echo $grupo; ?>
                <br/>
